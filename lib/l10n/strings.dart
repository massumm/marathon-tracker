...
class AppStrings extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        ...
        'ja_JP': {
          ...
          'gender': '性別',
          'gender_edit': '性別編集',
          'gender_required_to_run': 'イベントに参加する前に性別を設定してください。ライブリーダーボードで使用されます。',
          'set_gender': '性別を設定',
          ...
          'event_leaderboard': 'イベントランキング',
          'daily_challenge_leaderboard': 'デイリーチャレンジ',
          'no_daily_challenge_runs': 'まだデイリーチャレンジを実施した人はいません',
