        ...
        builder: (_, snap) {
          ...
          return Column(
            children: [
              ...
              if (runners.length < 3 && runners.isNotEmpty)
...
// ── Small podium when fewer than 3 runners ──────────────────────────────────
    ...
    return Container(
      ...
      child: Column(
        children: runners.asMap().entries.map((entry) {
          ...
          final r = entry.value;
          return _RunnerRow(runner: r, rank: rank);
        }).toList(),
      ),
    );
  }
...
// ── Row for rank 4+ (and small podium fallback) ─────────────────────────────
